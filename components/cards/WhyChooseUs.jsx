    ...
    return (
        <div className="p-[16px] bg-gradient-to-br from-orange-100 to-gray-200 rounded border border-orange-100 rounded-[4px]">
            ...
            <div className="flex flex-wrap gap-3">
                <div className="h-11 justify-start items-center gap-3 inline-flex mb-[20px]">
                    ...
                    <div className="flex-col justify-start items-start gap-0.5 inline-flex">
                        ...
                        <div className="text-neutral-400 text-xs font-normal">keep up with your rings, workouts, awards, and trends.</div>
                    </div>
                </div>
                <div className="h-11 justify-start items-center gap-3 inline-flex mb-[20px]">
                    <div className="w-[32px] h-[32px]">
                ...
                <div className="h-11 justify-start items-center gap-3 inline-flex">
                    <div className="w-[32px] h-[32px]">
